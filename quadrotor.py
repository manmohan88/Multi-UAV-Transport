...
class Quadrotor(object):
	...
	self.payload_angvelocity=np.zeros((3, 1))
	self.payload_orientation=np.zeros((4, 1))
	...
	self.payload_angvelocity=np.array([[data.twist.twist.angular.x], [data.twist.twist.angular.y], [data.twist.twist.angular.z]])
	self.payload_orientation=np.array([[data.pose.pose.orientation.x], [data.pose.pose.orientation.y], 		  			  [data.pose.pose.orientation.z],[data.pose.pose.orientation.w]])
	self.e_payload_position=self.payload_position-self.des_payload_position
